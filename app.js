document.addEventListener("DOMContentLoaded", async () => {
  ...
  const timeElapse = (date) => {
    ...
    const result = `Hari ke- <span class="digit">${days}</span> <span class="digit">${hours}</span> Jam <span class="digit">${minutes}</span> Menit <span class="digit">${seconds}</span> Detik`;
